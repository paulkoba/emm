...
public:
    ...
    IdentifierToken(llvm::StringRef value, std::int64_t line, TokenType::TokenType type) : Token(type, line), value(value) {}
...
class OperatorToken : public Token {
    llvm::StringRef value;
public:
    OperatorToken(llvm::StringRef value, std::int64_t line, TokenType::TokenType type) : Token(type, line), value(value) {}
...
public:
    NumericToken(llvm::StringRef value, llvm::StringRef literal, std::int64_t line, TokenType::TokenType type) : Token(type, line), value(value), literal(literal) {}
