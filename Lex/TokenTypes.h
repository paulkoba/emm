...
static std::int64_t getOperatorPrecedence(TokenType::TokenType token) {
    switch(token) {
        ...
        case TokenType::TokenType::NONE:
            return -1;
        default:
            compilationError("Precedence not defined for operator " + std::string(TokenType::toString(token)) + ". This is a compiler bug.");
            return -1;
    }
}
...
std::string functionNameFromTokenType(TokenType::TokenType op) {
    switch (op) {
        ...
        case TokenType::MINUS: return "operator_sub";
        case TokenType::PRODUCT: return "operator_mul";
        case TokenType::DIVISION: return "operator_div";
        case TokenType::MODULO: return "operator_mod";
        case TokenType::EQUALS: return "operator_equals";
        case TokenType::ASSIGN: return "operator_assign";
        case TokenType::GREATER: return "operator_greater";
        case TokenType::LESS: return "operator_less";
