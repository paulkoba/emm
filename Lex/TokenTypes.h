...
DECLARE_ENUM(TokenType, NONE, END_OF_FILE, IDENTIFIER, INTEGER, STRING, LPAREN, RPAREN, LBRACE, RBRACE, LBRACKET,
			 ...
			 MODULO_ASSIGN, BITWISE_AND, NOT, FLOATING_POINT, DOT, DOUBLE_COLON, KW_IF, KW_ELSE, KW_WHILE, KW_RETURN,
			 KW_LET, KW_FN, KW_TRUE, KW_FALSE, KW_MUT, KW_EXTERN, KW_STRUCT, KW_IMPL, KW_AS, KW_STATIC, KW_DEREF)
