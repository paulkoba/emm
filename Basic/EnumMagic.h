...
#ifndef EMMC_ENUMMAGIC_H
#define EMMC_ENUMMAGIC_H
...
// This will to define an enum that is wrapped in a namespace of the same name along with ToString(), FromString(), and
// COUNT
