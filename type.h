...
public:
    ...
    Type(llvm::Type* base, std::string name, bool useBuiltinOperators) : base(base), name(std::move(name)), useBuiltinOperators(useBuiltinOperators) {}
    Type(llvm::Type* base, std::string name, bool useBuiltinOperators, bool signedBuiltinOperators) : base(base), name(std::move(name)), useBuiltinOperators(useBuiltinOperators), signedBuiltinOperators(signedBuiltinOperators) {}
